...
const COPY = {
  zh: {
    ...
    textSize: "当前文字大小",
    textStyle: "当前文字样式",
    textStyleHint: "字体、颜色、大小、斜体只作用于上方选中的那一项",
    uploadSticker: "上传贴纸",
    stickerSize: "贴纸大小",
  ...
  en: {
    ...
    textStyle: "Style for selected text",
    textStyleHint: "Font, color, size, and italic apply only to the tab selected above",
...
Component({
  ...
  methods: {
    ...
    async _applyDraft(draft) {
      ...
      restorePosterColorState(this.posterState);
      this._applyScoreFromRound(this.properties.roundId);
    ...
    _rebuildPaletteOptions(languageArg) {
      ...
      options.push({
        ...
        total: (this.posterState.total && this.posterState.total.color) || style.total,
        card: style.card,
        line: style.line,
