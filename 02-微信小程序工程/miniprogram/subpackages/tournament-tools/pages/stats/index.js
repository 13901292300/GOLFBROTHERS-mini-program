...
function measureHeaderSafeArea() {
  const metrics = computeLandscapeHeaderMetrics();
  return {
    headerPadY: metrics.headerPadY,
    headerPadRight: metrics.headerPadRight,
    headerInnerH: metrics.headerInnerH,
    statsHeaderChrome: metrics.headerChrome
  };
}
