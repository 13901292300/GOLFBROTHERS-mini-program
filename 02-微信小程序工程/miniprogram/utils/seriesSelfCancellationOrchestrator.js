...
var seriesRegistration = require('./seriesRegistration.js');
...
function createSeriesSelfCancellationOrchestrator(deps) {
  ...
  var seriesStore = d.seriesStore || require('./seriesStore.js');
  var teamMatchStore = d.teamMatchStore || require('./teamMatchStore.js');
