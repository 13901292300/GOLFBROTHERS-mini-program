...
function deriveAssignmentsFromOrder(game, order) {
  var holeSides = require('./assignmentHoleSides.js').holeSidesFromOrder(game, order);
  if (!holeSides) return [];
  return fromHoleSides(withRolePolicy(holeSides, rolePolicyOf(game)));
}
...
module.exports = {
  ...
  stamp: stamp,
  deriveAssignmentsFromOrder: deriveAssignmentsFromOrder
};
